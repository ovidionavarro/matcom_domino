...
namespace matcom_domino
{
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("1:Reparticion en orden =>se le da a cada jugador 1 ficha y asi seguidamente pero la segunda ficha entregada" +'\n'+
            ...
            Console.WriteLine("Escriba la cantidad de fichas que kiere asignarle a cada jugador "+'\n'+"NOTA: Recuerde" +
                              ...
                              "esta es la divicion entre el total de fichas y el total de jugadores  ",domino.ConjuntodeFichas.Count()/domino.Jugadores.Count());
            ...
            while (true)
            {
                ...
                {
                    Console.WriteLine("ERROR,elija una cantidad menor igual a {0} y que no sea negativa, ni igual a 0,esto en caso de el repartidor" +
                                      "clasico,"+'\n'+"en caso del par seria la mitad",domino.ConjuntodeFichas.Count()/domino.Jugadores.Count());
